...
\noindent
MixColumns is the multiplication of each column by the polynomial $3x^{3}+x^{2}+x+2$ modulo $x^4+1$. As each product of an element of an ideal and arbritrary element of the ring is an element of the ideal as well, this operation doesn't change the ideal neither.\\
